...
function changePenColorToBlue() {
  document.getElementById("edit-contact-logo").src =
    "./asssets/img/edit-contact-blue.svg";
}
...
function renderContactDetailsMobile(i) {
  ...
  document.getElementById(`contact-logo-big${i}`).innerHTML =
    contact["initials"];
